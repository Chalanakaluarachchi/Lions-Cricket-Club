...
const SingleClass = () => {
  ...
  return (
    ...
    <div>
        <h1 className='text-5xl font-bold text-center'>Class  <span className='text-secondary'>Details</span></h1>
              ...
              <div className="lg:col-span-4 col-span-12 mt-8 md:mt-0">
                <div className="sidebarWrapper space-y-[30px]">
                  <div className="wdiget custom-text space-y-5 ">
                    ...
                    <h3>${classes?.price}</h3>
                    <button onClick={() => handelSelect(classes._id)} title={role === 'admin' || role === 'coach' ? 'Coach/Admin Can not be able to select ' ? classes?.availableSeats <1 : 'No seat avalible' : 'You can select this classes' } disabled={role === 'admin' || role === 'coach' || classes?.availableSeats < 1}  className="btn btn-primary w-full text-center bg-secondary py-2 px-6 text-white ">
                      Enroll Now
                    </button>
                    <ul className="list  ">
                      <li className=" flex space-x-3 border-b border-[#ECECEC] mb-4 pb-4 last:pb-0 past:mb-0 last:border-0">
                        ...
                        <div className="flex-none">{classes?.coachName}</div>
                      </li>

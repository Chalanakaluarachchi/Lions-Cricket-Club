...
const EnrolledClasses = () => {
    ...
    let itemPerPage = 4; // Changed to show 4 items per page
    ...
    }, [page, data]); // Ensure the effect runs when page or data changes
                    ...
                    ">
                        ...
                        ">
                            <div className="flex flex-col justify-start items-baseline">
                                ...
                                <span className="text-xs text-indigo-300 mt-0">by <span className='text-black'>{item.classes.coachName}</span></span>
                            </div>

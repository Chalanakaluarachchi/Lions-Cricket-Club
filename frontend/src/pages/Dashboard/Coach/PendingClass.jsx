...
import { FaUsers, FaChair, FaDollarSign, FaSpinner, FaEdit, FaEye } from 'react-icons/fa';
            ...
            <div className="my-9">
                ...
                <div className="text-center mt-4">
                    <Fade duration={100} className='text-base text-center' cascade>
                        Here you can see the classes pending by you and their status
                    </Fade>
                </div>

                <div className="mt-6">
                    {pendingClasses.length === 0 ? (
                        <div className='text-center text-2xl font-bold mt-10'>No pending classes yet</div>
                    ) : (
                                ...
                                <Slide key={index} duration={1000} className='hover:ring ring-secondary duration-200 focus:ring rounded-lg'>
                                    <div className="bg-white flex flex-col rounded-lg shadow p-4">
                                        ...
                                        <div className="flex flex-col gap-3">
                                            ...
                                            <div className="flex items-center">
                                                <FaSpinner className='text-orange-400 mr-2' />
                                                <span className='text-secondary'>
                                        ...
                                        <div className="mt-4 flex flex-col gap-2">
                                            <button onClick={() => handleFeedback(cls._id)} className='flex items-center justify-center px-4 py-2 bg-orange-400 font-bold text-white w-full rounded-lg'>
                                                View Feedback <FaEye className='ml-2' />
                                            </button>
                                            <button className='flex items-center justify-center px-4 py-2 bg-green-500 font-bold text-white w-full rounded-lg'>
                                                View Details <FaEye className='ml-2' />
                                            </button>
